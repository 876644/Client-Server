...
public class StudyGroup implements Comparable<StudyGroup>, Serializable {
    ...
    public StudyGroup( Long id,String user,String nameG, Coordinates coordinates, java.util.Date creationDate, Long studentsCount, FormOfEducation formOfEducation, Semester semesterEnum, Person groupAdmin){
        this.id = id;
        this.user = user;
        this.nameG = nameG;
